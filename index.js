...
if (fs.existsSync(DB_FILE)) {
  try {
    ...
    // حذف بيانات chatHealth القديمة إن كانت موجودة
    if (db.chatHealth) {
...
// ======================================================
//
// لا يوجد هنا messageCreate لمراقبة الشات.
// البوت لا يفحص الكلمات ولا يحذف رسائل الأعضاء تلقائيًا.
//
// /clear فقط يحذف الرسائل عندما يستخدمه Owner يدويًا.
// ======================================================
